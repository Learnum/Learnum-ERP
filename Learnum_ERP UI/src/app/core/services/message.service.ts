...
export class MessageService {
  invalidDataError(invalidDataError: any) {
    throw new Error('Method not implemented.');
  }
  duplicateEntryError(duplicateEntryError: any) {
    throw new Error('Method not implemented.');
  }
  ...
  updateSuccessfully: string = "Record updated successfully";
  ...
  iTDSubmittedSuccessfully = "IT Declaration submitted successfully";
  poiSubmittedSuccessfully = "Proof of investment submitted successfully.";
  pleaseSelectRegime = "Please select Regime";
  emailSent = "Email sent successfully";
  smsSent = "Email sent successfully";
